...
## 1. Merge the training and the test sets to create one dataframe.
## 2. Extracts only the mean and standard deviation for each measurement.
## 3. Uses descriptive activity names to name the data set
...
# Load: data column names from file
...
# Load and process X_train & y_train data from file
